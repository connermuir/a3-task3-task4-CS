...
This section includes some data reformatting  
...
Without considering additional factors, this graph appears to show a decline in the number of urchins observed across the sites over this time period. In each of the sites besides Isla Vista Reef where observation only began in 2012, urchin observations peaked between 2008 and 2012. To determine if these changes reflect actual changes in population, one would have to be sure that the conditions of observation (i.e. time spent observing). It would also be helpful to identify any external variables like shifting environmental conditions that could justify the theory that urchin populations are declining in Santa Barbara. Otherwise, these declines could be tied to the study design or methods and not reflective of population shifts. 
